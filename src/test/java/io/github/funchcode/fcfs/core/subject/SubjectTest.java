...
public class SubjectTest {
    ...
    void newInstance_InvalidLimitedQuantity() {
        ...
        LocalDateTime ongoingOpenDate = today.minusDays(1L);
        LocalDateTime ongoingDeadlineDate = today.plusDays(2L);
        Assertions.assertThrows(FcfsIllegalArgumentException.class, () -> Subject.newInstance(zeroLimitedQuantity, ongoingOpenDate, ongoingDeadlineDate));
        Assertions.assertThrows(FcfsIllegalArgumentException.class, () -> Subject.newInstance(minusLimitedQuantity, ongoingOpenDate, ongoingDeadlineDate));
    ...
    void newInstance_InvalidOpenDeadlineDateSet() {
        ...
        Assertions.assertThrows(FcfsIllegalArgumentException.class, () -> Subject.newInstance(validLimitedQuantity, afterFiveDays, afterFourDays));
    ...
    void newInstance_InvalidPastDeadlineSet() {
        ...
        Assertions.assertThrows(FcfsIllegalArgumentException.class, () -> Subject.newInstance(validLimitedQuantity, beforeFourDays, beforeFiveDays));
        Assertions.assertThrows(FcfsIllegalArgumentException.class, () -> Subject.newInstance(validLimitedQuantity, beforeFiveDays, beforeFourDays));
    }
